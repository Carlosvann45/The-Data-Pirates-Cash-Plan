package io.thedatapirates.cashplan.domains.profile
...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNav = findViewById(R.id.navProfileBottomNavigation)
        navView = findViewById(R.id.nvProfileTopNavigationWithHeader)
        drawerLayout = findViewById(R.id.dlProfileActivity)
        ...
        navProfileBottomNavigation.setOnNavigationItemSelectedListener {
            when (it.itemId) {
        ...
        navView.setCheckedItem(R.id.navProfileActivity)
    }
