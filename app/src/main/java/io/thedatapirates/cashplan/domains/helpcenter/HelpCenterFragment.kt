...
class HelpCenterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        helpItems.add(
            HelpItem(
                "What is Ca\$h Plan and how can I use it?",
        ...
        helpItems.add(
            HelpItem(
                "What is the Cash Flow page and how can I use it?",
        ...
        helpItems.add(
            HelpItem(
                "What is the Expense page and how can I use it?",
        ...
        helpItems.add(
            HelpItem(
                "What is the Investment page and how can I use it?",
